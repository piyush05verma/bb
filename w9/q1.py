...
# ---------------- Save Attrition Count ----------------
attrition_count = df.groupBy("Attrition").count()
attrition_count.show()

attrition_count.write.mode("overwrite").csv(
    "hdfs://localhost:9000/user/230968114/lab9/output/attrition_count"
)

# ---------------- Save Avg Salary ----------------
avg_salary = df.groupBy("Department").avg("MonthlyIncome")
avg_salary.show()

avg_salary.write.mode("overwrite").csv(
    "hdfs://localhost:9000/user/230968114/lab9/output/avg_salary"
)
...
pred.select("features", "Attrition_idx", "prediction").write.mode("overwrite").csv(
    "hdfs://localhost:9000/user/230968114/lab9/output/classification"
)
...
pred2.select("features2", "MonthlyIncome", "prediction").write.mode("overwrite").csv(
    "hdfs://localhost:9000/user/230968114/lab9/output/regression"
)
